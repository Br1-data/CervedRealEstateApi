<?php
/**
 * CointestatariFabbricatoRequest
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * CointestatariFabbricatoRequest Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CointestatariFabbricatoRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CointestatariFabbricatoRequest';
     ...
     * Sets subalterno
     *
     * @param int $subalterno Per il Catasto fabbricati, dove presente, identifica un bene immobile, compresa la singola unità immobiliare esistente su una particella.
     *
     * @return $this
     */
